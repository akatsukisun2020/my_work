...
def produce_signals():
    # produce signal
    signal1 = produce_one_signal(1, 37, 39, 4.5, 4.6, 5.0, 5.8, signal_numbers + 320, 0)
    signal2 = produce_one_signal(50, 38, 40, 1.0, 1.2, 7.0, 7.3, signal_numbers + 320, 1)
    signal3 = produce_one_signal(100, 39, 41, 3.0, 3.1, 3.0, 3.8, signal_numbers + 320, 2)
    signal4 = produce_one_signal(200, 36, 42, 1.0, 5.1, 3.0, 6.8, 40, 3)
